...
/***/ "./app/javascript/lib/angular-resource.min.js":
/*!****************************************************!*\
  !*** ./app/javascript/lib/angular-resource.min.js ***!
  \****************************************************/
/*! no static exports found */
            ...
            var p = G.resolve(q).then(C)["catch"](D).then(d),
              ...
              if (e) {
                ...
                if (b.isArray) l.length = 0, r(e, function (a) {
                  "object" === typeof a ? l.push(new h(a)) : l.push(a);
                });else {
                  var d = l.$promise;
                  M(e, l);
                  l.$promise = d;
...
/***/ "./app/javascript/lib/angular-route.min.js":
/*!*************************************************!*\
  !*** ./app/javascript/lib/angular-route.min.js ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./app/javascript/lib/angular-sanitize.min.js":
/*!****************************************************!*\
  !*** ./app/javascript/lib/angular-sanitize.min.js ***!
  \****************************************************/
/*! no static exports found */
  ...
  c.module("ngSanitize", []).provider("$sanitize", function () {
    ...
    function A(a) {
      for (; a;) {
        if (a.nodeType === s.Node.ELEMENT_NODE) for (var e = a.attributes, d = 0, b = e.length; d < b; d++) {
          ...
          if ("xmlns:ns1" === g || 0 === g.lastIndexOf("ns1:", 0)) a.removeAttributeNode(k), d--, b--;
        }
        (e = a.firstChild) && A(e);
        a = v("nextSibling", a);
      }
    ...
    K = function K(a, e) {
      ...
      for (b = d.firstChild; b;) {
        ...
        var k;
        if (!(k = b.firstChild) && (1 === b.nodeType && e.end(b.nodeName.toLowerCase()), k = v("nextSibling", b), !k)) for (; null == k;) {
          b = v("parentNode", b);
          if (b === d) break;
          k = v("nextSibling", b);
    ...
    C = function C(a, e) {
      var d = !1,
          b = F(a, a.push);
      return {
        start: function start(a, g) {
          a = q(a);
          !d && w[a] && (d = a);
          d || !0 !== m[a] || (b("<"), b(a), G(g, function (d, g) {
            var c = q(g),
    ...
    var z = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
      ...
      var g;
      if (e && e.implementation) g = e.implementation.createHTMLDocument("inert");else throw D("noinert");
      var c = (g.documentElement || g.getDocumentElement()).querySelector("body");
      c.innerHTML = '<svg><g onload="this.parentNode.remove()"></g></svg>';
      return c.querySelector("svg") ? (c.innerHTML = '<svg><p><style><img src="</style><img src=x onerror=alert(1)//">', c.querySelector("svg img") ? d : b) : function (b) {
        b = "<remove></remove>" + b;
  ...
  c.module("ngSanitize").filter("linky", ["$sanitize", function (f) {
    ...
    return function (c, z, u) {
      ...
      for (var p = A(u) ? u : v(u) ? function () {
        ...
        w = c[0], c[2] || c[4] || (w = (c[3] ? "http://" : "mailto:") + w), m = c.index, r(n.substr(0, m)), x(w, c[0].replace(t, "")), n = n.substring(m + c[0].length);
      }
...
/***/ "./app/javascript/lib/angular.min.js":
/*!*******************************************!*\
  !*** ./app/javascript/lib/angular.min.js ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "./app/javascript/lib/array.coffee":
/*!*****************************************!*\
  !*** ./app/javascript/lib/array.coffee ***!
  \*****************************************/
/*! no static exports found */
...
setTimeout(function() {
  ...
  this.Array.prototype.diffByField = function(arr, field) {
    var result;
    result = this.map(function(item) {
      if (arr.indexOfById(item[field], {
        key: field
      }) < 0) {
        return item;
      }
  ...
  this.Array.prototype.diffById = function(arr) {
    return this.diffByField(arr, 'id');
  };
  ...
  if (!this.Array.prototype.forEach) {
    return this.Array.prototype.forEach = function(fn) {
...
/***/ "./app/javascript/lib/ng-sortable.min.js":
/*!***********************************************!*\
  !*** ./app/javascript/lib/ng-sortable.min.js ***!
  \***********************************************/
/*! no static exports found */
...
!function () {
  ...
  mainModule.factory("$helper", ["$document", "$window", function ($document, $window) {
    return {
      ...
      offset: function offset(element, scrollableContainer) {
      ...
      eventObj: function eventObj(event) {
        var obj = event;
      ...
      isTouchInvalid: function isTouchInvalid(event) {
        var touchInvalid = !1;
      ...
      positionStarted: function positionStarted(event, target, scrollableContainer) {
        var pos = {};
      ...
      calculatePosition: function calculatePosition(pos, event) {
      ...
      movePosition: function movePosition(event, element, pos, container, containerPositioning, scrollableContainer) {
        var bounds,
            useRelative = "relative" === containerPositioning;
      ...
      dragItem: function dragItem(item) {
        return {
          ...
          canMove: function canMove(itemPosition, targetElement, targetElementOffset) {
          ...
          moveTo: function moveTo(parent, index) {
          ...
          isSameParent: function isSameParent() {
            return this.parent.element === this.sourceInfo.sortableScope.element;
          },
          isOrderChanged: function isOrderChanged() {
      ...
      noDrag: function noDrag(element) {
        return void 0 !== element.attr("no-drag") || void 0 !== element.attr("data-no-drag");
      },
      findAncestor: function findAncestor(el, selector) {
        el = el[0];
  ...
  mainModule.controller("as.sortable.sortableController", ["$scope", function ($scope) {
    this.scope = $scope, $scope.modelValue = null, $scope.callbacks = null, $scope.type = "sortable", $scope.options = {
      longTouch: !1
    }, $scope.isDisabled = !1, $scope.insertItem = function (index, itemData) {
    ...
    return {
      ...
      link: function link(scope, element, attrs, ngModelController) {
        ...
        ngModel = ngModelController, ngModel && (ngModel.$render = function () {
          ...
          return !0;
        }, callbacks.orderChanged = function (event) {}, callbacks.itemMoved = function (event) {}, callbacks.dragStart = function (event) {}, callbacks.dragMove = angular.noop, callbacks.dragCancel = function (event) {}, callbacks.dragEnd = function (event) {}, scope.$watch(attrs.asSortable, function (newVal, oldVal) {
  ...
  mainModule.controller("as.sortable.sortableItemHandleController", ["$scope", function ($scope) {
    ...
    return {
      ...
      link: function link(scope, element, attrs, itemController) {
        ...
        function fetchScope(element) {
          for (var scope; !scope && element.length;) {
            scope = element.data("_scope"), scope || (element = element.parent());
          }
        ...
        }), createPlaceholder = function createPlaceholder(itemScope) {
        ...
        }, dragListen = function dragListen(event) {
          var startPosition,
              unbindMoveListen = function unbindMoveListen() {
            angular.element($document).unbind("mousemove", moveListen), angular.element($document).unbind("touchmove", moveListen), element.unbind("mouseup", unbindMoveListen), element.unbind("touchend", unbindMoveListen), element.unbind("touchcancel", unbindMoveListen);
              ...
              moveListen = function moveListen(e) {
            e.preventDefault();
        ...
        }, isDraggable = function isDraggable(event) {
          var elementClicked, sourceScope, isDraggable;

          for (elementClicked = angular.element(event.target), sourceScope = fetchScope(elementClicked), isDraggable = sourceScope && "handle" === sourceScope.type; isDraggable && elementClicked[0] !== element[0];) {
            $helper.noDrag(elementClicked) && (isDraggable = !1), elementClicked = elementClicked.parent();
          }
        ...
        }, placeHolderIndex = function placeHolderIndex(targetElement) {
          var itemElements, i;
          if (targetElement.hasClass(sortableConfig.placeHolderClass)) return 0;

          for (itemElements = targetElement.children(), i = 0; i < itemElements.length; i += 1) {
            if (angular.element(itemElements[i]).hasClass(sortableConfig.placeHolderClass)) return i;
          }

          return -1;
        }, isPlaceHolderPresent = function isPlaceHolderPresent(targetElement) {
        ...
        }, dragCancel = function dragCancel(event) {
        ...
        }, longTouchStart = function longTouchStart(event) {
          longTouchTimer = $timeout(function () {
            dragListen(event);
          }, 500);
        }, longTouchCancel = function longTouchCancel() {
          $timeout.cancel(longTouchTimer);
        }, escapeListen = function escapeListen(event) {
          27 === event.keyCode && dragCancel(event);
        }, angular.element($document[0].body).bind("keydown", escapeListen), bindEvents = function bindEvents() {
...
__webpack_require__(/*! lib/angular.min */ "./app/javascript/lib/angular.min.js");

__webpack_require__(/*! lib/angular-route.min */ "./app/javascript/lib/angular-route.min.js");

__webpack_require__(/*! lib/angular-sanitize.min */ "./app/javascript/lib/angular-sanitize.min.js");

__webpack_require__(/*! lib/angular-resource.min */ "./app/javascript/lib/angular-resource.min.js");

__webpack_require__(/*! lib/array.coffee */ "./app/javascript/lib/array.coffee");

__webpack_require__(/*! lib/ng-sortable.min */ "./app/javascript/lib/ng-sortable.min.js");

__webpack_require__(/*! src/app_angular.coffee */ "./app/javascript/src/app_angular.coffee");

__webpack_require__(/*! src/controllers/board_ctrl.coffee */ "./app/javascript/src/controllers/board_ctrl.coffee");

__webpack_require__(/*! src/resources/board.coffee */ "./app/javascript/src/resources/board.coffee");

__webpack_require__(/*! src/controllers/step_ctrl.coffee */ "./app/javascript/src/controllers/step_ctrl.coffee");

__webpack_require__(/*! src/resources/step.coffee */ "./app/javascript/src/resources/step.coffee");

__webpack_require__(/*! src/controllers/task_ctrl.coffee */ "./app/javascript/src/controllers/task_ctrl.coffee");

__webpack_require__(/*! src/resources/task.coffee */ "./app/javascript/src/resources/task.coffee"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/***/ "./app/javascript/src/app_angular.coffee":
/*!***********************************************!*\
  !*** ./app/javascript/src/app_angular.coffee ***!
  \***********************************************/
/*! no static exports found */
...
angular.module('appSystem', ['ngResource', 'ngRoute', 'ngSanitize', 'as.sortable']).config([
...
/***/ "./app/javascript/src/controllers/board_ctrl.coffee":
/*!**********************************************************!*\
  !*** ./app/javascript/src/controllers/board_ctrl.coffee ***!
  \**********************************************************/
/*! no static exports found */
...
angular.module('appSystem').controller('BoardCtrl', [
  'Board', function(Board) {
    var closures, vm;
    vm = this;
    vm.init = function() {
      return closures.list(function() {
        var boardId, ref;
        boardId = localStorage.getItem('board_id');
        boardId = parseInt(boardId) || ((ref = vm.boards.first()) != null ? ref.id : void 0);
        return vm.load({
          id: boardId
        });
      });
    ...
    vm.form = {
      init: function(board) {
        if (board) {
          this.params = angular.copy(board);
        } else {
          this.params = {
            title: ''
          };
        }
        return $('#boardModal').modal('show');
      },
      submit: function() {
        return closures.save(this.params, function() {
          return $('#boardModal').modal('hide');
        });
      },
      destroy: function() {
        return closures.destroy(this.params, function() {
          return $('#boardModal').modal('hide');
        });
      }
    };
    vm.load = function(board) {
      if (!board) {
        vm.current = {};
        return;
      }
      return closures.show(board, function() {
        return localStorage.setItem('board_id', board.id);
      });
    };
    closures = {
      list: function(callback) {
        Board.list({}, function(data) {
          closures.handle(data.items);
          return typeof callback === "function" ? callback() : void 0;
        });
        return function(response) {
          var ref;
          return alert((ref = response.data) != null ? ref.errors : void 0);
        };
      },
      show: function(board, callback) {
        if (vm.loading || !board.id) {
          return;
        }
        vm.loading = true;
        return Board.show({
      ...
      save: function(params, callback) {
        ...
        return Board[action](params, function(data) {
          vm.loading = false;
          closures.handle(data);
          if (action === 'create') {
            vm.load(data);
      ...
      destroy: function(params, callback) {
        if (!confirm("Tem certeza que deseja destruir o Quadro " + params.title + "?")) {
          return;
        }
        if (vm.loading) {
          return;
      ...
      handle: function() {
        ...
        for (i = 0, len = items.length; i < len; i++) {
          ...
          if (((ref = vm.current) != null ? ref.id : void 0) === item.id) {
            results.push(vm.current = item);
          } else {
            results.push(void 0);
          }
        }
...
/***/ "./app/javascript/src/controllers/step_ctrl.coffee":
/*!*********************************************************!*\
  !*** ./app/javascript/src/controllers/step_ctrl.coffee ***!
  \*********************************************************/
/*! no static exports found */
...
angular.module('appSystem').controller('StepCtrl', [
  'Step', function(Step) {
    var closures, vm;
    vm = this;
    vm.init = function(board) {
      var ref;
      vm.board = board;
      return vm.steps = ((ref = vm.board) != null ? ref.steps : void 0) || [];
    };
    vm.form = {
      init: function(step, modal) {
        this.modal = modal != null ? modal : false;
        if (step) {
          this.params = angular.copy(step);
        } else {
          this.params = {
            title: ''
          };
      ...
      cancel: function() {
        ...
        return $('#stepModal').modal('hide');
      },
      submit: function() {
        return closures.save(this.params, function() {
          return vm.form.cancel();
        });
      },
      destroy: function() {
        return closures.destroy(this.params);
      }
    };
    closures = {
      save: function(params, callback) {
        ...
        return Step[action](params, function(data) {
          vm.loading = false;
          closures.handle(data);
          return typeof callback === "function" ? callback(data) : void 0;
        }, function(response) {
      ...
      destroy: function(params, callback) {
        if (!confirm("Tem certeza que deseja destruir a Etapa " + params.title + "?\nTodas as Tarefas dessa Etapa serão EXCLUÍDAS!")) {
          return;
        }
        if (vm.loading) {
          return;
      ...
      handle: function() {
        ...
        for (i = 0, len = items.length; i < len; i++) {
          item = items[i];
          results.push(vm.steps.addOrExtend(item));
        }
        return results;
      }
    };
...
/***/ "./app/javascript/src/controllers/task_ctrl.coffee":
/*!*********************************************************!*\
  !*** ./app/javascript/src/controllers/task_ctrl.coffee ***!
  \*********************************************************/
/*! no static exports found */
...
angular.module('appSystem').controller('TaskCtrl', [
  'Task', function(Task) {
    var closures, vm;
    vm = this;
    vm.init = function(step) {
      var ref;
      vm.step = step;
      return vm.tasks = ((ref = vm.step) != null ? ref.tasks : void 0) || [];
    };
    vm.form = {
      init: function(task, modal) {
        this.modal = modal != null ? modal : false;
        if (task) {
          this.params = angular.copy(task);
        } else {
          this.params = {
            title: ''
          };
        ...
        return $("#taskModal" + vm.step.id).modal('show');
      },
      cancel: function() {
        this.params = {};
        if (!this.modal) {
        ...
        return $("#taskModal" + vm.step.id).modal('hide');
      },
      submit: function() {
        return closures.save(this.params, function() {
          return vm.form.cancel();
    ...
    vm.sortable = {
      dragControlListeners: {
        itemMoved: function(event) {
          var newStep, params, ref, ref1, task;
          task = event.source.itemScope.modelValue;
          newStep = (ref = event.dest.sortableScope.$parent) != null ? (ref1 = ref.vmTask) != null ? ref1.step : void 0 : void 0;
          if (!newStep) {
            return;
          }
          params = {
    ...
    closures = {
      save: function(params, callback) {
        ...
        vm.loading = true;
        action = params.id ? 'update' : 'create';
        if (!params.skipStepId) {
          params.step_id = vm.step.id;
        }
        return Task[action](params, function(data) {
          vm.loading = false;
          if (data.step_id === vm.step.id) {
            closures.handle(data);
          }
          return typeof callback === "function" ? callback(data) : void 0;
        }, function(response) {
      ...
      destroy: function(params, callback) {
        if (!confirm("Tem certeza que deseja destruir a Tarefa " + params.title + "?")) {
          return;
        }
        if (vm.loading) {
          return;
      ...
      handle: function() {
        ...
        for (i = 0, len = items.length; i < len; i++) {
          item = items[i];
          results.push(vm.tasks.addOrExtend(item));
        }
        return results;
      }
    };
...
/***/ "./app/javascript/src/resources/board.coffee":
/*!***************************************************!*\
  !*** ./app/javascript/src/resources/board.coffee ***!
  \***************************************************/
/*! no static exports found */
...
angular.module('appSystem').factory('Board', [
  '$resource', function($resource) {
    ...
    return $resource('/boards/:id.json', {
      id: '@id'
    }, {
      show: {
        method: 'GET'
...
/***/ "./app/javascript/src/resources/step.coffee":
/*!**************************************************!*\
  !*** ./app/javascript/src/resources/step.coffee ***!
  \**************************************************/
/*! no static exports found */
...
angular.module('appSystem').factory('Step', [
  '$resource', function($resource) {
    var encapsulateData;
    encapsulateData = function(data) {
      return JSON.stringify({
...
/***/ "./app/javascript/src/resources/task.coffee":
/*!**************************************************!*\
  !*** ./app/javascript/src/resources/task.coffee ***!
  \**************************************************/
/*! no static exports found */
...
angular.module('appSystem').factory('Task', [
  '$resource', function($resource) {
    var encapsulateData;
    encapsulateData = function(data) {
      return JSON.stringify({
...
/******/ });
//# sourceMappingURL=application-282e58d49861290efaf6.js.map